 ...
 *
 * @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/scripts/tree.js#1 $$Change: 946917 $
...
function WebTree() {
  ...
  /** type of selector control, i.e. radio or checkbox */
...
WebTree.prototype.initializeAfterLoad = function() {
  ...
  if (this.shouldScrollIntoView) {
    var item = (this.highlightedItem ? this.highlightedItem : this.selectedItem);
    if (item) {
      if (dijit != null && typeof dijit.scrollIntoView === "function")
        dijit.scrollIntoView(item);
      else
        item.scrollIntoView();
    }
  }
