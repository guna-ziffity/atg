<%--
  ...
  @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/expreditor/buttonEditor.jsp#1 $$Change: 946917 $
...
<dspel:page>
  ...
  <c:choose>
    <c:when test="${not empty paramExpression.descriptionAccoringToUserlocale}">
      <c:set var="buttonLabel" value="${paramExpression.descriptionAccoringToUserlocale}"/>
    </c:when>
    <c:otherwise>
