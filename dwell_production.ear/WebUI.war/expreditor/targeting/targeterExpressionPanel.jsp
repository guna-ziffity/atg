<%--
  ...
  @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/expreditor/targeting/targeterExpressionPanel.jsp#1 $$Change: 946917 $
...
<dspel:page>
  ...
  <dspel:include page="commonExpressionPanelEditor.jsp">
    ...
    <dspel:param name="currentExpressionType" value="targeter"/>
    <dspel:param name="groupRenderer" value="/expreditor/targeting/renderTargeterRulesetGroup.jsp"/>
  </dspel:include>
