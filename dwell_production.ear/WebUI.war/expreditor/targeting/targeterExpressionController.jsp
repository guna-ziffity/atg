<%--
  ...
  @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/expreditor/targeting/targeterExpressionController.jsp#1 $$Change: 946917 $
...
<dspel:page>
  ...
  <c:choose>
    ...
    <%-- rulesets add/delete/move operations --%>

    <c:when test="${param.operation == 'addRuleset'}">
      <ee:createRuleset expressionModel="${model}"
                        rulesetGroupIndex="${param.rulesetGroupIndex}"
                        rulesetIndex="${param.rulesetIndex}"
                        rulesetGroupType="${param.type}"/>
    </c:when>
    ...
    <c:when test="${param.operation == 'deleteRuleset'}">
      <ee:deleteRuleset expressionModel="${model}"
                        rulesetGroupIndex="${param.rulesetGroupIndex}"
                        rulesetIndex="${param.rulesetIndex}"
                        rulesetGroupType="${param.type}"/>
    </c:when>
    ...
    <%-- rulesetGroups add/delete/move operations --%>
    ...
    <%-- Site filter related operations --%>
    <c:when test="${param.operation == 'addSiteFilterDefinition'}">
      <ee:createSiteFilterDefinition
          expressionModel="${model}"
          rulesetGroupIndex="${param.rulesetGroupIndex}"
          rulesetIndex="${param.rulesetIndex}"
          rulesetGroupType="${param.type}"/>
