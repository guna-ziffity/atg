...
<dspel:page>
  ...
  <fmt:setBundle basename="atg.service.preview.PreviewResources"/>
  ...
  <%-- add anonymous user --%>
  {
    "name":"<fmt:message key="anonymousUser"/>",
...
<%-- @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/preview/getPreviewUsers.jsp#1 $$Change: 946917 $--%>
