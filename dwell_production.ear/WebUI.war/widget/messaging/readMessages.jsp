                    ...
                    <json:object>
                      ...
                      <c:if test="${isDebug and not empty detail.cause}">
                        <json:object name="cause">
                          <json:property name="className" value="${detail.cause['class'].name}"/>
                      ...
                      <c:if test="${isDebug and not empty detail.source}">
                        <json:object name="source">
                          <json:property name="className" value="${detail.source['class'].name}"/>
...
<%-- @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/widget/messaging/readMessages.jsp#1 $$Change: 946917 $--%>
