...
<%--
  ...
  @version $Id: //product/WebUI/version/11.2/src/web-apps/WebUI/tree/tree.jsp#3 $$Change: 1195314 $
  @updated $DateTime: 2015/09/11 12:01:03 $$Author: mdiamond $
  --%>
...
<dspel:page>
  ...
  <dspel:importbean bean="/atg/dynamo/droplet/ArrayIncludesValue"/>
  <dspel:importbean bean="/atg/web/tree/TreeJavascriptContent"/>
  ...
  <script type="text/javascript">
    ...
    tree.selectorControl = "<c:out value='${param.selectorControl}'/>";
    

    <c:if test="${not empty param.onLoad}">
      <dspel:droplet name="ArrayIncludesValue">
        <dspel:param bean="TreeJavascriptContent.contentList" name="array"/>
        <dspel:param name="value" value="${param.onLoad}"/>
        ...
        <dspel:oparam name="false">
          <%
            String jsString = (String)request.getParameter("onLoad");
            System.err.println("Suspect XSS attempt: Invalid content for tree.onLoad. To allow please add " + jsString + " to /atg/web/tree/TreeJavascriptContent.properties");
          %>
        </dspel:oparam>
      </dspel:droplet>  <% /* End of ArrayIncludesValue */ %>
    </c:if>

    <c:if test="${not empty param.onSelect}">
      <dspel:droplet name="ArrayIncludesValue">
        <dspel:param bean="TreeJavascriptContent.contentList" name="array"/>
        <dspel:param name="value" value="${param.onSelect}"/>
        <dspel:oparam name="true">
        ...
        <dspel:oparam name="false">
          <%
            String jsString = (String)request.getParameter("onSelect");
            System.err.println("Suspect XSS attempt: Invalid content for tree.onLoad. To allow please add " + jsString + " to /atg/web/tree/TreeJavascriptContent.properties");
          %>
        </dspel:oparam>
      </dspel:droplet>  <% /* End of ArrayIncludesValue */ %>
    ...
    <c:if test="${not empty param.onUnselect}">
      <dspel:droplet name="ArrayIncludesValue">
        <dspel:param bean="TreeJavascriptContent.contentList" name="array"/>
        <dspel:param name="value" value="${param.onUnselect}"/>
        <dspel:oparam name="true">
        ...
        <dspel:oparam name="false">
          <%
            String jsString = (String)request.getParameter("onUnselect");
            System.err.println("Suspect XSS attempt: Invalid content for tree.onLoad. To allow please add " + jsString + " to /atg/web/tree/TreeJavascriptContent.properties");
          %>
        </dspel:oparam>
      </dspel:droplet>  <% /* End of ArrayIncludesValue */ %>
    ...
    <c:if test="${not empty param.onCheck}">
      <dspel:droplet name="ArrayIncludesValue">
        <dspel:param bean="TreeJavascriptContent.contentList" name="array"/>
        <dspel:param name="value" value="${param.onCheck}"/>
        <dspel:oparam name="true">
        ...
        <dspel:oparam name="false">
          <%
            String jsString = (String)request.getParameter("onCheck");
            System.err.println("Suspect XSS attempt: Invalid content for tree.onLoad. To allow please add " + jsString + " to /atg/web/tree/TreeJavascriptContent.properties");
          %>
        </dspel:oparam>
      </dspel:droplet>  <% /* End of ArrayIncludesValue */ %>
    ...
    <c:if test="${not empty param.onUncheck}">
      <dspel:droplet name="ArrayIncludesValue">
        <dspel:param bean="TreeJavascriptContent.contentList" name="array"/>
        <dspel:param name="value" value="${param.onUncheck}"/>
        <dspel:oparam name="true">
        ...
        <dspel:oparam name="false">
          <%
            String jsString = (String)request.getParameter("onUncheck");
            System.err.println("Suspect XSS attempt: Invalid content for tree.onLoad. To allow please add " + jsString + " to /atg/web/tree/TreeJavascriptContent.properties");
          %>
        </dspel:oparam>
      </dspel:droplet>  <% /* End of ArrayIncludesValue */ %>
  ...
  <div style="display: none">
    <dspel:iframe id="actionFrame" name="treeActionFrame" page="/tree/treeActionFrame.jsp"/>
  </div>
